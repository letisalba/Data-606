...
**_Based on the results below, 71.7% of the sample thinks climate change affects their local community._**
...
**_This 95% confidence interval is a range of values where we are 95% certain that it contains the true proportion of the population._**
...
**_Yes, the confidence interval captures the true population._**
...
**_Each student would and should get a slightly different confidence interval because every sample from the population will be different. They should however capture the true population mean because at a 95% confidence level it is expected._**
...
**_Majority of the proportions of confidence intervals include the true population proportion. This proportion is close to equal to the 95% confidence level._**
...
**_I am 80% confident that the true proportions of US Adults think climate change affects their local community is within the confidence intervals of (65%, 80%)._*
*
```{r}
#80% confidence level
samp %>%
...
**_Using the app, with 80% confidence level, it shows the true population to be lower than 95%. With the true population being lower, the confidence level also decreases and is narrower._**
...
**_I used the app to run 90% confidence level. This confidence level, when compared to the first one is much wider. When calculating the bounds of the interval you get (61.70%, 80%)._**
 ...
 **_As you increase the sample size, the width of the intervals decrease and vice versa._**
...
**_Using the app I noticed that increasing the number of bootstrap will the sampling distribution narrow, therefore, it should decrease the standard error as well._**
